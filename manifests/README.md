...
| [`ops-files/use-kube-dns.yml`](ops-files/use-kube-dns.yml) | Replace CoreDNS with Kube-DNS in the list of addons deployed by the apply-specs errand | - |
